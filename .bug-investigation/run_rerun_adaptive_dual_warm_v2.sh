#!/usr/bin/env bash
# ============================================================================
# JOB 2v2 — ADAPTIVE DUAL WARM RE-RUN, EARLY-STOPPING OFF (Path-A decisive)
# ============================================================================
...
LOG=$REPO/.bug-investigation/rerun-adaptive-dual-warm-v2.log
cd "$REPO"
: > "$LOG"

echo "================================================================" | tee -a "$LOG"
echo "[$(date '+%Y-%m-%d %H:%M:%S')] JOB 2v2 — ADAPTIVE DUAL WARM RE-RUN ES-OFF (PID $$)" | tee -a "$LOG"
...
echo "" | tee -a "$LOG"
echo "================================================================" | tee -a "$LOG"
echo "[$(date '+%Y-%m-%d %H:%M:%S')] RERUN_ADAPTIVE_DUAL_WARM_V2 FINISHED rc=$RC" | tee -a "$LOG"
echo "================================================================" | tee -a "$LOG"
