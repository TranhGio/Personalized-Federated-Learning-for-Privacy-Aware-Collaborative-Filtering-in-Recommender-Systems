...
- For cross-device diagnostics (per-user interaction histograms, sparse/medium/dense bucket distribution), see the eval-harness outputs under `../../results/federated/baseline/<run_id>/` once Phase 6 lands.
